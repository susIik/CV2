...
\descript{Tootearendus ja Tootmistehnika magister}
\location{2024 - 2026}
Keskmine hinne: 5.0 (66 EAP)
...
\begin{tightitemize}
  ...
  \item Projekteerin \textbf{lehtmetallist} valmistatud, \textbf{3D prinditud} kui ka \textbf{freesitud} detaile \textbf{Solidworks} tarkvara abil.
  \item \textbf{Optimeerin} toodete disaine, et vähendada kaalu, mõõtmeid ja tootmiskulusid.
  \item Kombineerin \textbf{mehaanilisi} ja \textbf{elektrilisi} komponente, et valmistada lõplik \textbf{toode}.
  \item \textbf{Vastutan} alamsüsteemide valmimise ning \textbf{dokumenteerimise} eest.
  \item Valmistan \textbf{ostunimekirju} ning suhtlen ettevõtetega probleemide lahendamiseks.
  \item \textbf{Koostan} ja testin \textbf{prototüüpe} ning teen disainis muudatusi vastavalt ilmnenud probleemidele.
  \item Teostan \textbf{tugevusarvutusi} ning \textbf{FEM} analüüse detailidele.
  \item \textbf{Õpetan} praktikante ning \textbf{juhendan} neid ülesannete lahendamisel.
\end{tightitemize}
...
\location{September 2023 - Juuni 2024}
%\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
...
\descript{| Tootearendaja}

\location{Aprill 2022 - Juuni 2024}
%\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
...
\runsubsection{Automaatne žgutt}
\descript{| Isiklik projekt}

\location{2025-2026}
\begin{tightitemize}
\item Grupitööna disainisime ning \textbf{prototüüpisime} automaatse žguti, mis on mõeldud kasutamiseks militaarmeditsiinis.
\item Seade on võimeline automaatselt tuvastama jäseme verejooksu ning žguti aktiveerima, nii et verejooks peatatakse.
\item Žgutt kogub andmed vererõhu ning pulsi anduritest ja töötleb neid \textbf{ESP32} mikrokontrolleriga.
\item Seadme ootuspäraseks töötamiseks teostasin \textbf{FEM} analüüsi ning \textbf{elektrilised arvutused}.
\item Hetkel jätkan projekti arendamist lõputöö raames.
\end{tightitemize}
