...
%\begin{tightitemize}
%  \item Tiimiga ehitame andurriba Trimemory, mis võimaldab purjekale pannes teada saada täpse purje kuju ja seega optimeerida purje trimmi.
...
\location{2021 - 2022}
\begin{tightitemize}
\item Alustasin projektiga, sest tahtsin luua elektrirula, millega saab sõita ilma kiirusejuhtimise pulti käes hoidmata.
\item Kiiruse kontrollimise jaoks saadakse andmed \textbf{tensotajuritest} (strain gauge), mis on paigutatud rula väändtelgedele.
...
\item Lisaks aitasin kaasa teiste mehaanikaalaste küsimuste lahendamisel.
\end{tightitemize}
